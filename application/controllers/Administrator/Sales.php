    ...
    public function addSales()
    {
        ...
        try {
            ...
            $sales = array(
                ...
                'is_installment'                 => $data->sales->is_installment,
                'installment'                    => $data->sales->installment,
                'installment_amount'             => $data->sales->installment_amount,
            ...
            if ($data->sales->is_installment == 'true' && $data->customer->Customer_Type != 'G') {
                ...
                for ($i = 1; $i <= $data->sales->installment; $i++) {
                    ...
                    $installment = array(
                        ...
                        'payment_amount' => $data->sales->installment_amount,
                        'status'         => 'p',
                        'AddBy'          => $this->session->userdata("userId"),
                        'AddTime'        => date('Y-m-d H:i:s'),
                        'last_update_ip' => get_client_ip(),
